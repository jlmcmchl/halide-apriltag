...
void ThresholdPipeline::prepare_buffers(int width, int height) {
    if (!input_buf_) {
...
void ThresholdPipeline::run(int min_white_black_diff, uint8_t *input_data, uint8_t *output_data, int width, int height) {
...
void ThresholdPipeline::copy_input_to_buffer(uint8_t *input_data, int width, int height) {
    if (!input_buf_) {
        return;
    }
...
void ThresholdPipeline::copy_buffer_to_output(uint8_t *output_data, int width, int height) {
    if (!output_buf_) {
        return;
    }
