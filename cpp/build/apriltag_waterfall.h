#ifndef HALIDE__apriltag_waterfall_h
#define HALIDE__apriltag_waterfall_h
#include <stdint.h>
...
int atag_waterfall(struct halide_buffer_t *_labels_in_buffer, struct halide_buffer_t *_waterfall_labels_buffer);

HALIDE_FUNCTION_ATTRS
int atag_waterfall_argv(void **args);

HALIDE_FUNCTION_ATTRS
const struct halide_filter_metadata_t *atag_waterfall_metadata();
