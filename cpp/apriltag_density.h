#ifndef HALIDE__apriltag_density_h
#define HALIDE__apriltag_density_h
#include <stdint.h>
...
int atag_density(struct halide_buffer_t *_edge_in_buffer, int32_t _density_neighborhood_size, float _density_threshold_ratio, struct halide_buffer_t *_density_buffer);

HALIDE_FUNCTION_ATTRS
int atag_density_argv(void **args);

HALIDE_FUNCTION_ATTRS
const struct halide_filter_metadata_t *atag_density_metadata();
